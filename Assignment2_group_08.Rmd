...
portfolio_size %>%
  ...
  labs(x = 'Portfolio return desity',
       y = NULL,
       title = 
         'Figure 1: Density plot returns of small and large size portolios') +
...
portfolio_bm %>%
  ...
  labs(x = 'Portfolio return density',
       y = NULL,
       title = 'Figure 2: Density plot returns of low and high BM portolios') +
  scale_fill_manual(values = c('orange', 'grey'),
                    name = 'Portfolio',
...
bind_rows(betas_size, means_size) %>%
  ...
  labs(x = 'Beta',
       y = 'Mean returns',
       title = 'Figure 3: Size portfolio, momentum betas and returns') +
  mytheme
...
bind_rows(betas_BM, means_BM) %>%
  ...
  labs(x = 'Beta',
       y = 'Mean returns',
       title = 'Figure 4: BM portfolios, momentum betas and returns') +
  mytheme
